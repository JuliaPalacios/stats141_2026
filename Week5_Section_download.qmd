...
<div class="header-row">
  <h1 class="page-title">Week 5 Section</h1>
...
1.  Construct one-sample confidence intervals using both the $Z$ and $t$ methods.
...
To compute the standard error, we also need sample sizes and standard deviations from the data:
