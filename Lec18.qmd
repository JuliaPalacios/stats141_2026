...
$$\left[\hat{\beta}_{0}-2\cdot SE(\hat{\beta}_{0}),\ \hat{\beta}_{0}+2\cdot SE(\hat{\beta}_{0})\right]$$ {#eq-6} $$\left[\hat{\beta}_{1}-t_{.975,n-2}\cdot SE(\hat{\beta}_{1}),\ \hat{\beta}_{1}+t_{.975,n-2}\cdot SE(\hat{\beta}_{1})\right]$$ {#eq-7}
