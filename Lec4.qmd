...
<a href="Lec4_annotated.pdf" class="download-btn" download> ⬇ Download Annotated Slides </a>
:::
...
Two events are **mutually exclusive** if both events cannot occur simultaneously. For example $E_{1}$ and $E_{2}$ defined above are mutually exclusive and $$ P(E_{1} \text{ and } E_{2})=0$$ {{< pagebreak >}}
...
Example: $E_{1}$=The first die roll is 3, and $E_{2}$=The second die roll is $3$.
