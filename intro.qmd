...
<a href="docs/Lec1_annotated.pdf" class="download-btn" download> ⬇ Download Annotated Slides </a>
:::
...
-   Deviation: $y_i - \bar{y}$
-   Mean deviation: $\frac{\sum^{n}_{i=1}|y_{i}-\bar{y}|}{n}$
