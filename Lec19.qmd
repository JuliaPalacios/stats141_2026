...
<a href="Lec19_annotated.pdf" class="download-btn" download> ⬇ Download Annotated Slides </a>
:::
...
$$\hat{Y} = \hat{\beta}_{0} + \hat{\beta}_{1}X_{1} + \hat{\beta}_{2}X_{2} + \dots + \hat{\beta}_{m}X_{m} $$. {#eq-10}
