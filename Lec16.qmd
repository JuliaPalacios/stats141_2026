...
qbinom(.025,180,.7)/180
qbinom(.975,180,.7)/180
...
$$
\hat{p}\pm t_{.975,n-1}SE(\hat{p})
$$

where $t_{.975.n-1}$ is the quantile of the t distribution with n-1 degrees of freedom.
...
```
Indeed very similar to the exact CI.
